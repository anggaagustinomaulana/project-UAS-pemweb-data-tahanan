...
<head>
  ...
  <title>Lapas NusaKemambang| Login</title>
...
<div class="login-box">
  <div class="login-logo">
    <a href="Assets/index2.html"><b>Lapas </b>NusaKemambang</a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <?php
        if (isset($_POST['login'])) {
            ...
            $sql_login = mysqli_query($conn, "SELECT * FROM db_login WHERE username = '$user' AND password = '$pass'") 
